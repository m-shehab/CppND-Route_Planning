...
This repository contains the code for the 1st project of Udacity C++ Nanodegree. A Route Planning using A* Search.
...
```
git clone https://github.com/m-shehab/CppND-Route_Planning.git --recurse-submodules
```
or with SSH:
```
